package ro.hasna.tutorials.db_comparison.sync_jpa_mysql.controller;
...
import ro.hasna.tutorials.db_comparison.sync_jpa_mysql.service.ArticleService;
...
public class ArticleController {
    ...
    @GetMapping("/{id}")
    public ArticleResponse getArticleById(@PathVariable(name = "id") long articleId) {
        return articleService.findArticleById(articleId);
    }

    @DeleteMapping("/{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteArticleById(@PathVariable(name = "id") long articleId) {
