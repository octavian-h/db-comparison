...
import ro.hasna.tutorials.db_comparison.reactive_mysql.service.ArticleService;
...
public class ArticleController {
    ...
    @GetMapping("/{id}")
    public Mono<ArticleResponse> getArticleById(@PathVariable(name = "id") long articleId) {
        return articleService.findArticleById(articleId);
    }

    @DeleteMapping("/{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public Mono<Void> deleteArticleById(@PathVariable(name = "id") long articleId) {
